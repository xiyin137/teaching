...
class SDP:
    ...
    def reshuffle_with_normalization(self, vector, norm):
        ...
        """
        # Avoid float-casting high-precision entries: large truncations can
        # overflow to inf and pick an unstable normalization component.
        max_index = 0
        max_abs = abs(norm[0])
        ...
        if abs(norm[max_index]) < tiny:
            raise ZeroDivisionError("Normalization vector has no nonzero component.")
